...
begin
  ...
  begin
    edtLogin.SetFocus;
    Application.MessageBox('Informe o seu Login!!', 'Atenção', MB_OK+MB_ICONINFORMATION);
    Abort;
  end;
  if Trim(edtSenha.Text) = '' then
  begin
    edtSenha.SetFocus;
    Application.MessageBox('Informe sua Senha!!', 'Atenção', MB_OK+MB_ICONINFORMATION);
    Abort;
  end;
  ...
  try
    ...
    begin
      Application.MessageBox(PWideChar(Erro.Message), 'Atenção', MB_OK+MB_ICONINFORMATION);
      edtLogin.SetFocus;
    end;
  end;
end;
